...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]Puff puff pass[/B][/COLOR]Wizard'
BUILDERNAME = 'AnimaHaze'
EXCLUDES = [ADDON_ID, 'repository.hazewizard']
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Puff puff pass[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing OpenWizard.\n\nContact us on Github at https://github.com/a4k-openproject/plugin.program.openwizard/'
...
REPOID = 'repository.haze'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML = 'https://raw.githubusercontent.com/AnimaHaze/repository.haze/main/repo/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://raw.githubusercontent.com/AnimaHaze/repository.haze/main/repo/zips/repository.haze/'
#########################################################
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]Puff puff pass[/B][/COLOR]Wizard'
